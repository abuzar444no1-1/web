    ...
    <div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mt-12">
          <button className="bg-orange-500 text-white px-8 py-3 rounded-lg hover:bg-orange-600 transition duration-150 font-semibold">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">All restaurants follow strict safety protocols</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Curated selection of top-rated restaurants</p>
            </div>
          </div>
        </div>
      </section>
